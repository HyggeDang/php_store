...
?> 
<head>
<title><?php echo $ten_san_pham?> | H2CL Clothing</title>
</head>
...
?>%</span>
       ...
       ?>
        ...
        <form class="add-to-cart-form" action="index.php?act=wishlist" method="POST">
                    ...
                    <span class="ms-4 ps-2">Thêm vào danh sách yêu thích</span>
                  </button>
                  </form> 
        ...
        <ul class="single-product-meta list-unstyled border-top pt-7 mt-7">
          <li class="d-flex mb-4 pb-2 align-items-center">
            <span class="text-body-emphasis fw-semibold fs-14px">Kho:</span>
            ...
            <div class="accordion-item pb-4">
              <h2 class="accordion-header" id="flush-headingOne">
                <a class="product-info-accordion text-decoration-none" href="#" data-bs-toggle="collapse" data-bs-target="#flush-collapseOne" aria-expanded="false" aria-controls="flush-collapseOne">
                  <span class="fs-4">Mô tả sản phẩm</span>
                </a>
              </h2>
            </div>
  ...
  <section class="container container-xxl pt-15 pb-15 pt-lg-17 pb-lg-20">
    <div class="text-center">
      <h2 class="mb-12">Sản phẩm liên quan</h2>
    </div>
...
echo $phan_tram_giam_gia ?>% </span>
            ...
            <div class="position-absolute d-flex z-index-2 product-actions  vertical">
              <a class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm wishlist" href="#" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Thêm vào Wishlist">
                <svg class="icon icon-star-light">
                  <use xlink:href="#icon-heart"></use>
                </svg>
              </a>
              <!-- <a class="text-body-emphasis bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm compare" href="compare.html" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="So sánh">
