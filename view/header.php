...
<html lang="en" data-bs-theme="light">
  ...
  <head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap" rel="stylesheet">
      ...
      <div class="bg-primary bg-opacity-15">
        <div class="container-xxl container d-flex py-4">
          ...
          <div class="w-100 text-center">
            <p class="mb-0 fs-14px fw-bold text-primary text-uppercase">Miễn phí vận chuyển cho thành viên mới</p>
          </div>
          <div class="w-50 d-none d-lg-block">
              ...
              <div class="icons-actions d-flex justify-content-end w-xl-50 fs-28px text-body-emphasis">
                <div class="px-xl-5 d-inline-block">
                  <a class="lh-1 color-inherit text-decoration-none" href="#" data-bs-toggle="offcanvas" data-bs-target="#searchModal" aria-controls="searchModal" aria-expanded="false">
                    <svg class="icon icon-magnifying-glass-light" style="width: 2rem; height: 2rem;">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end fs-14px" data-bs-popper="static">
                    <li>
                      <button type="button" class="dropdown-item d-flex align-items-center active" data-bs-theme-value="light" aria-pressed="true">
                        <svg class="bi me-4 opacity-50 theme-icon">
                          <use href="#sun-fill"></use>
                        </svg> Sáng <svg class="bi ms-auto d-none">
                          <use href="#check2"></use>
                        </svg>
                      </button>
                    </li>
                    <li>
                      <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="dark" aria-pressed="false">
                        ...
                        </svg> Tối <svg class="bi ms-auto d-none">
                          <use href="#check2"></use>
                        </svg>
                      </button>
                    </li>
                    <li>
                      <button type="button" class="dropdown-item d-flex align-items-center" data-bs-theme-value="auto" aria-pressed="false">
                        ...
                        </svg> Tự động <svg class="bi ms-auto d-none">
                          <use href="#check2"></use>
                        </svg>
                      </button>
                    </li>
            ...
            <div class="d-none d-xl-flex flex-column flex-xl-row w-100">
                ...
                <div class="icons-actions d-none d-xl-flex justify-content-start me-auto fs-28px text-body-emphasis">
                  <div class="pe-6">
                    <a class="lh-1 color-inherit text-decoration-none" href="#" data-bs-toggle="offcanvas" data-bs-target="#searchModal" aria-controls="searchModal" aria-expanded="false">
                      ...
                      <!-- <span class="fs-20px !important">Tìm Kiếm </span> -->
                    </a>
                  </div>
                </div>
                            ...
                            <ul class="list-unstyled mb-0">
                              ...
                              <li>
                                <a href="index.php?act=wishlist" class="border-hover text-decoration-none py-3 d-block">
                                  <span class="border-hover-target">Danh sách Yêu thích</span>
                                </a>
                              </li>
                            </ul>
                          </div>
              ...
              <div class="px-10 d-none d-xl-flex align-items-center ">
                <a href="index.php" class="navbar-brand px-8 py-4 mx-auto">
                  <img class="light-mode-img" src="image\logo.png" width="179" height="100" alt="H2Cl Clothing">
                  <img class="dark-mode-img" src="image\logo.png" width="179" height="100" alt="H2Cl Clothing">
                </a>
              </div>
              <div class="w-auto w-xl-50 d-flex align-items-center">
                <ul class="navbar-nav w-100 w-xl-auto">
                <li class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover">
                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px dropdown-toggle" href="#" data-bs-toggle="dropdown" id="menu-item-pages" aria-haspopup="true" aria-expanded="false">Liên Hệ</a>
                    <ul class="dropdown-menu py-6" aria-labelledby="menu-item-pages">
                      ...
                      <li>
                        <a class="dropdown-item pe-6 border-hover" href="index.php?act=listspdm&ma_loai=all" target="_blank">
                  ...
                  <li class="nav-item transition-all-xl-1 py-xl-11 py-0 px-xxl-8 px-xl-6 dropdown dropdown-hover dropdown-fullwidth">
                    <a class="nav-link d-flex justify-content-between position-relative py-xl-0 px-xl-0 text-uppercase fw-semibold ls-1 fs-15px fs-xl-14px dropdown-toggle" href="#" data-bs-toggle="dropdown" id="menu-item-docs" aria-haspopup="true" aria-expanded="false">Tài Khoản</a>
                ...
                <div class="icons-actions d-none d-xl-flex justify-content-end ms-auto fs-28px text-body-emphasis">
                  ...
                  <div class="px-5 d-none d-xl-inline-block">
                    <a class="position-relative lh-1 color-inherit text-decoration-none" href="index.php?act=wishlist">
                      <svg class="icon icon-star-light" style="width: 1.5rem; height: 1.5rem;">
        ...
        <nav class="navbar navbar-expand-xl px-0 py-6 py-xl-12 row align-items-start">
          <div class="col-xl-3 d-flex justify-content-center justify-content-xl-start">
            <a href="index-2.html" class="navbar-brand py-4 d-lg-inline-block">
              <img src="image/logo.png" height="50" alt="Glowing - Bootstrap 5 HTML Templates">
            </a>
          </div>
          <div class="col-xl-6 d-flex justify-content-center">
            <form class="w-xl-100 w-sm-75 w-100 mt-6 mt-xl-0 px-6 px-xl-0" method="POST" action="index.php?act=search">
              ...
              <div class="d-flex align-items-center justify-content-center mt-6">
                <p class="text-muted mb-0 mr-3">Mọi người cũng tìm kiếm</p>
                <nav class="nav">
                  <a class="nav-link text-decoration-underline py-0 px-4" href="#">Áo khoác phao</a>
                  <a class="nav-link text-decoration-underline py-0 px-4" href="#">Áo len</a>
                  <a class="nav-link text-decoration-underline py-0 px-4" href="#">Quần nỉ</a>
                </nav>
              </div>
            </form>
          </div>
