...
<head>
<title>Trang chủ | H2CL Clothing</title>
</head>
    ...
    <div class="pt-14 pb-14 pt-lg-19 pb-lg-16">
      <div class="container container-xxl mb-13 d-xl-flex">
            <div class="flex-grow-1 text-left" data-animate="fadeInUp">
                <h2 class="mb-5">Sản phẩm bán chạy</h2>
            ...
            <div class="card card-product grid-1 bg-transparent border-0">
              <figure class="card-img-top position-relative mb-7 overflow-hidden ">
                ...
                if($so_luong == 0){
                  ?>
                    ...
                    <button style="margin: 10px;" class="text-body-emphasis bg-body border-0 bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm add_to_cart" href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Sản phẩm hết hàng">
                    ...
                    <button type="submit" name="addcart" style="margin: 10px;" class="text-body-emphasis  border-0 bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm add_to_cart" href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Thêm Vào giỏ hàng">
                    <svg class="icon icon-shopping-bag-open-light">
                      <use xlink:href="#icon-shopping-bag-open-light"></use>
                    </svg>
                  </button>
                ...
                <form class="add-to-cart-form" action="index.php?act=wishlist" method="POST">
                  ...
                  <button type="submit" name="wishlistadd" style="margin: 10px;" class="text-body-emphasis border-0 bg-body bg-dark-hover text-light-hover rounded-circle square product-action shadow-sm add_to_cart" href="#" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Thêm vào wishlist">
              ...
              <div class="card-body text-center p-0">
                ...
                <div class="d-flex align-items-center fs-12px justify-content-center">
                  ...
                  <span class="reviews ms-4 pt-3 fs-14px">Đã bán <?php echo $so_luong_ban?></span>
                </div>
              </div>
            </div>
                    </div>
...
<div class="text-left">
<p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">BỘ SƯU TẬP MỚI</p><h2 class="fs-20 w-md-50 w-lg-100 w-xl-80 mb-4 me-7 me-md-25">Áo Khoác Mùa Đông 2024</h2>
<p class="fs-18px mb-0 text-body-calculate">Khám Phá bộ sưu tập mới, trẻ trung, Phù hợp với mọi lứa tuổi.</p></div>
<a href="index.php?act=listspdm&ma_loai=1" class="mt-10 btn btn-white shadow-sm">Khám phá ngay</a>
</div>
<div class="col-lg-8 order-1 order-lg-2" data-animate="fadeIn">
<img class="lazy-image img-fluid light-mode-img size-img" src="#" data-src="image/bst2024.jpg" width="923" height="640" alt="other-01">
<img class="lazy-image dark-mode-img img-fluid size-img" src="#" data-src="image/bst2024.jpg" width="923" height="640" alt="other-01">
</div>
</div>
</div>
</section>
  <section class="container container-xxl pt-15 pb-16 pb-lg-18 pt-lg-19">
    <div class="text-center" data-animate="fadeInUp">
      ...
      <h2 class="mb-6">Bạn còn nhiều thời gian để mua sắm ? <br></h2>
    </div>
    <div class="row mt-13">
      <?php
    ...
    <div class="text-center mt-10">
      <a href="index.php?act=listspdm&ma_loai=all" target="_blank" class="btn btn-outline-dark">Tất cả sản phẩm</a>
    </div>
  </section>
  <section class="bg-section-3">
    <?php
        $data = sanpham_get_byid(31);
        extract($data);
    ?>
    <div class="container container-xxl">
      <div class="row align-items-center">
        ...
        <div class="col-lg-5 py-lg-0 py-13" data-animate="fadeInUp">
          <div class="text-left">
            <p class="fs-15px mb-6 ls-1 text-body-emphasis fw-semibold">SALE Chớp Nhoáng<span class="badge bg-primary fs-15px fw-500 ms-4">-<?php
$phan_tram_giam_gia = round(($don_gia - $giam_gia) / $don_gia * 100); 
echo $phan_tram_giam_gia ?>% </span>
            </p>
            <h2 class="mb-6"><?php echo $ten_san_pham?></h2>
          </div>
          <div class="d-flex countdown ms-n4 ms-md-n7" data-countdown="true" data-countdown-end="Jan 27, 2025 18:24:25">
          ...
          <a href="index.php?act=ctsp&ma_san_pham=<?php echo $ma_san_pham?>" class="mt-11 btn btn-white shadow-sm">Giá sốc <?php echo number_format($giam_gia, 0, ',', '.').'đ' ?></a>
        </div>
      </div>
    </div>
  </section>
        ...
        <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
          <div class="icon-box icon-box-style-1 card border-0 text-center">
            ...
            <div class="icon-box-content card-body pt-4">
              <h3 class="icon-box-title card-title fs-5 mb-4 pb-2">FREESHIP</h3>
              <p class="icon-box-desc card-text fs-18px mb-0">Miễn Phí Vận Chuyển Cho Đơn Hàng Từ 500.000 VND</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
          <div class="icon-box icon-box-style-1 card border-0 text-center">
            ...
            <div class="icon-box-content card-body pt-4">
              <h3 class="icon-box-title card-title fs-5 mb-4 pb-2">ĐỔI HÀNG TRONG VÒNG 15 NGÀY</h3>
              <p class="icon-box-desc card-text fs-18px mb-0">Hỗ Trợ Đổi Hàng Trong 15 Ngày</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
          <div class="icon-box icon-box-style-1 card border-0 text-center">
            ...
            <div class="icon-box-content card-body pt-4">
              <h3 class="icon-box-title card-title fs-5 mb-4 pb-2">TƯ VẤN LỰA CHỌN VÀ MẶC ĐỒ</h3>
              <p class="icon-box-desc card-text fs-18px mb-0">Đội Ngũ Tư Vấn Tận Tình 24/7</p>
            </div>
          </div>
        </div>
        <div class="col-xl-3 col-md-6" data-animate="fadeInUp">
